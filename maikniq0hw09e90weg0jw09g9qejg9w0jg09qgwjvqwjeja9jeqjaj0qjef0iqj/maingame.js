class Game {
    constructor() {
        ...
        this.falseobstaclegroup = new Group();
        ...
        this.sanhand.scale = 1

    }
    play(){
        var immunity = createSprite(20,0,50,50);
        var immunityOver =  createSprite(20, 390, 50, 50);
      //  this.bg.x = 400
      //  this.bg.y = 200;
      fill("black")
      textFont("Comic Sans Ms")
      textSize(15)
      text("Points Required: 200", 600, 50);
      text("Points: " + this.sc, 600, 100);
      textSize(20)
      ...
      this.ground.visible = false;
        ...
        if(dummy === 0){
            ...
            this.touch();
            this.falseObstacle();
           immunity.velocityY = 1;
           if(immunity.isTouching(immunityOver)){
               dummy = 0;
            //   immunity.destroy();
             //  immunityOver.destroy();
           }
    ...
    falseObstacle(){
        if (frameCount % 100 === 0) {
            ...
            this.falseobstaclegroup.add(obstacle)
    
}

//clearTimeout(this.dummy);
}
